...
![protofire-1](./img/screenshot_17-6-2025_11597_app.safe.protofire.io.jpeg, "Home")

Safeに名前を付け、Hoodiネットワークを選択した後、`Next`ボタンをクリックして続けます。

![protofire-2](./img/screenshot_17-6-2025_12918_app.safe.protofire.io.jpeg, "Name")

次に全クラスタメンバーの署名者アドレスを追加し、`Next`ボタンをクリックして最後の手順に進みます。

![protofire-3](./img/screenshot_17-6-2025_121524_app.safe.protofire.io.jpeg, "Signer")

最後に`Create account`ボタンをクリックしてSafeを作成するためのトランザクションを送信します。

![protofire-4](./img/screenshot_17-6-2025_121730_app.safe.protofire.io.jpeg, "Create")
...
![ssv-operator-1](./img/upload_094fdcaf6b4dbf5f300f12f34db90ed7.png, "Join")

`Register Operator` ボタンをクリックしてください。

![ssv-operator-2](./img/upload_44b8141ec8fa97d2185ddc2ce14ed189.png, "Register")

Setup項の手順3で生成した公開鍵を入力し、`Private`トグルを選択して次の手順に進みます。

![ssv-operator-3](./img/upload_f2853fbb1f47723b5450332549192d56.png, "Private")

オペレーター料金に 0 を設定し、 `Next`ボタンをクリックします。

![ssv-operator-4](./img/upload_82c3b69efd8f1d6e1dced41af0f6ce55.png, "Fee")

最後に、`Register Operator`ボタンをクリックしてオペレーターを登録し 、トランザクションに署名します。

![ssv-operator-5](./img/upload_d12a41eb3414e85ba20853989cf4601c.png, "Confirm")

トランザクションが実行されると、オペレーターを使用する準備が整います。

![ssv-operator-6](./img/upload_a455018d80177953993321a17d4d1e4a.png, "Transaction")

オペレーターIDをメモし、 `Manage Operator`ボタンをクリックします。

![ssv-operator-7](./img/upload_bf6f31c4bc38f935daace4026bc0f4a1.png, "Manage")

右上隅にある3つのドットボタンを選択し、 `Permission Settings`オプションを選択します。

![ssv-operator-8](./img/upload_627cb169592b23a682631cc43ba2a161.png, "Permission")

`Authorized Addresses`オプションをクリックします。

![ssv-operator-9](./img/upload_63bdbd439f0c33349e7df0e149cf6e62.png, "Authorized")

Safeウォレットのアドレスを入力し 、`Add Addresses` ボタンをクリックしてトランザクションに署名します。

![ssv-operator-10](./img/upload_49201ce0c87458e7d5bdfef12ad3849b.png, "Add")
...
![dkg-testing-1](./img/upload_89b603bf376b8640dabec3d26471dfd4, "Test")

## Publishing the DKG endpoint to the operator registry

画面の右上隅にある 3つのドットボタンを選択し、`Operator details` `Edit Details` オプションを選択します。

![dkg-endpoint-1](./img/upload_627cb169592b23a682631cc43ba2a161, "DKG")

画面下部の`DKG Endpoint`フィールドにURLを入力し、`Update`ボタンをクリックして、署名で変更を確認します。

![dkg-endpoint-2](./img/upload_f46d6e37ecfa8bb28df4099d81bcede3, "Update")
...
![cluster-1](./img/upload_59ebb9d3c7ac58d6d3faccab420f19b5, "Wallet")

それから次のページの`Distribute Validator`ボタンをクリックします。

![cluster-2](./img/upload_53b0d22b09fea3e1fde8ed331862b0e9, "DV")

そして `Generate new key shares` ボタンをクリックします。

![cluster-3](./img/upload_9f119de847bd7d949a7779710913e97e, "Share")

クラスターサイズを選択し、リストからクラスターオペレーターを選択して、 `Next`ボタンをクリックします。

![cluster-4](./img/upload_83620a211bfd3956b3ebfce9763bda9e, "Select")

`Offline` ボタンをクリックします。

![cluster-5](./img/upload_9e8ec7c71fd9aa2a609b11bb9d8994b9, "Offline")
...
![cluster-6](./img/upload_5a23ee256c55bb0154be7b17c89121e0, "Lido")
...
![cluster-7](./img/upload_39e7b6470c634b94ddbdc70239564c92, "Ceremony")
...
![cluster-8](./img/upload_0944a2a0faaeb613bc9cbfe62bc686ec, "Tree")

ウェブブラウザに戻り、バリデーターの入金に関する記述を確認し(ただし、現時点ではまだ行われていません)、`Register Validator`ボタンをクリックしてください。

![cluster-9](./img/upload_3f41edd4685b817e8f5278ce04441fd8, "Register")
...
![cluster-10](./img/upload_06d9273fd18658db0b6cd8a7604fe9a6, "Cluster")
...
![cluster-11](./img/upload_ca08c26d1f2e0a206c7215b29bb7288d, "Fund")

クラスターの残高と手数料に関する警告を確認して同意し、`Next`ボタンをクリックします。

![cluster-12](./im/upload_326ac5b774282217a7dbdde19a043d92, "Balances")

スラッシングリスクに関する警告を確認して同意し、`Next`ボタンをクリックします。

![cluster-13](./img/upload_2210bada7817223607670e0d87a24f1a, "Slashing")

SSVの支払いを承認します。

![cluster-14](./img/upload_5f27ff3061e952785807671ecb8dc2ae, "Approve")

`Safe`でトランザクションに署名し、他のクラスタメンバーと共有します。

![cluster-15](./img/upload_88974802dffcb412f888e14ee5a69fdb, "Signer")

署名のしきい値に達し、トランザクションが実行されたら、`Register Validators`ボタンをクリックします。

![cluster-16](./img/upload_9aaa60458d6319b99f2f6945f27fb5e0, "Validator")

再度署名し、トランザクションを他のクラスタ・メンバーと共有します。

![cluster-17](./img/upload_d624a17aaf5c92871169e7ab990ffbc9, "Share")
...
![cluster-18](./img/upload_54d2f53d84b8c6632a05fda9f8bafbd0, "Fee")
...
![cluster-19](./img/upload_0499c18b4b97aa660d84951f2c646e4b, "Recipient")

再度`Safe`にサインインし、トランザクション承認のために他のクラスターメンバーと共有します。

![cluster-20](./img/upload_74f2b5c6a587132973b626218d6b52b6, "Transaction")
...
![verify-1](./img/upload_12e21eb771705cb1dba26a3c0d707718, "Copy")
...
![verify-2](./img/upload_eaec19451c0d303f20e5f2dd455779a9, "Deposits")
...
![verify-3](./img/upload_ac150d44d1734ce9bf3c5783dd87ab60, "Copy")
...
![verify-4](./img/upload_7803e13eb05e3dd36c6eed0d2643116d, "Grep")
...
![lido-csm-1](./img/upload_ce917f5ba09606d8c161faf71e61f7ed, "Wallet")

接続リンクをコピーします...

![lido-csm-2](./img/upload_88fe79ca5834db92c088a977d0519a1b, "Connect")

それを `Safe` `WalletConnect` 画面に貼り付けます。

![lido-csm-3](./img/upload_d3ffd10da0f6a7570adb0d83e73972df, "SafeWallet")

次に`Create Node Operator`ボタンをクリックします。

![lido-csm-4](./img/upload_b1908c079db963f5bba3e36b47876666, "Node")

`Upload deposit data`フィールドに`deposit-data.json`の中身を貼り付けます。

クラスター`Safe`には、債券をカバーするのに十分なETH/stETH/wstETHが預けられている必要があります。

![lido-csm-5](./img/upload_cea8ca9bf6852f7a3ab311e3c975b61e, "Bond")

`Specify custom addresses`セクションを展開します...

![lido-csm-6](./img/upload_8861824de32bdea38a422b60290d5279, "Custom")
...
![lido-csm-7](./img/upload_4cb1fbd8b87f0b5dc947be17a9e42d9f, "Create")

`Safe`でトランザクションに署名し、他のクラスタメンバーと共有します。

![lido-csm-8](./img/upload_1318b2f5d1c43d601e424baf68041503, "Share")

取引に署名する前に、残りのメンバーは、取引の詳細に正しいマネージャーアドレス(`Safe`のアドレス)と報酬アドレス(Splitsコントラクトのアドレス)が含まれていることを確認する必要があります。

![lido-csm-9](./img/upload_d83befba4b7e21913011c532bcbf8f8b, "Check")

署名のしきい値に達し、トランザクションが実行されると、クラスタはLido CSMから入金する準備が整います。

![lido-csm-10](./img/upload_df324e8937bfc2565235936d1d463b73, "Finish")
...
![claiming-1](./img/upload_e61118e39c370aef02cf92bbcf96e1ea, "Claim")

## Exiting Validators

[SSV Web](https://app.ssv.network/)アプリを使用してバリデーターを終了できます。

![exiting-1](./img/upload_ad6a86e2df828ad365540850c775f60c, "Exit")
