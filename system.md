...
| **Valut** | **Saturn0** | `A` | **Rocket Pool: LEB8 minipool プライマリ出金アドレス** | `m/44'/60'/10'/0/0` | `address_index=0` のみ使用。 |
| **Valut** | **Saturn1** | `A` | **Rocket Pool: LEB4 megapool プライマリ出金アドレス** | `m/44'/60'/10'/0/0` | `address_index=0` のみ使用。 |
| **Valut** | **Saturn2** | `A` | **Rocket Pool: LEB1.5 megapool プライマリ出金アドレス** | `m/44'/60'/10'/0/0` | `address_index=0` のみ使用。 |
...
| **Operations** | **SSV** | `B` | **SSV: DVクラスタ管理者アドレス** | `m/44'/60'/0'/0/0` | Gnosis Safe{Wallet}の代わり。 |
| **Operations** | **Obol** | `B` | **Obol: DVクラスタ管理者アドレス** | `m/44'/60'/0'/0/0` | Glosis Safe{Wallet}の代わり。 |
